...
<head>
  ...
  <link rel="stylesheet" href="css/aksoyhlc.css">
</head>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <li class="nav-item active">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="musteriyukle.php">Müşteri Yükle</a>
          </div>
        </div>
      </li>
      ...
      <?php if (yetkikontrol()): ?>
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#kullanicimeby" aria-expanded="true" aria-controls="kullanicimeby">
          <i class="fas fa-users"></i>
          <span>Kullanıcılar</span>
        </a>
        <div id="kullanicimeby" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Kullanıcı İşlemleri:</h6>
            <a class="collapse-item" href="kullanicilar.php">Tüm Kullanıcılar</a>
            <a class="collapse-item" href="kullaniciekle.php">Kullanıcı Ekle</a>
          </div>
        </div>
      </li>
    <?php endif ?>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="img-profile rounded-circle" src="dosyalar/<?php echo $ayarcek['site_logo'] ?>">
                </a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a class="btn btn-primary" href="islemler/cikis.php">Çıkış</a>
                </div>
              </div>
            </div>
          </div>
